...
class TestEasemobActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_test_easemob)
        ...
        mBtnSendMsg001.setOnClickListener {
            ...
            message.setMessageStatusCallback(object : EMCallBack {
                override fun onSuccess() {
                    runOnUiThread {
                        Toast.makeText(this@TestEasemobActivity, "发送成功", Toast.LENGTH_SHORT).show()
                    }
                }
                ...
                override fun onError(code: Int, error: String?) {
                    runOnUiThread {
                        Toast.makeText(this@TestEasemobActivity, "发送失败", Toast.LENGTH_SHORT).show()
                    }
                }
